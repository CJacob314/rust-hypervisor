...
const __u64 _KVM_INTERRUPT = KVM_INTERRUPT;
#undef KVM_INTERRUPT
const __u64 KVM_INTERRUPT = _KVM_INTERRUPT;

const __u64 _KVM_CREATE_DEVICE = KVM_CREATE_DEVICE;
#undef KVM_CREATE_DEVICE
const __u64 KVM_CREATE_DEVICE = _KVM_CREATE_DEVICE;

const __u64 _KVM_TRANSLATE = KVM_TRANSLATE;
#undef KVM_TRANSLATE
const __u64 KVM_TRANSLATE = _KVM_TRANSLATE;
